...
Public Declare Function initColorTemp Lib "ColorT.dll" (ByRef Timming As Long, ByRef Pattern As Long, ByRef Calibration As Long, ByRef MinBri As Long, ByVal ModelFile As String, ByVal pCurDir As String) As Long

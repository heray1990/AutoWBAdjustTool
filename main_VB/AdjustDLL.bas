...
Public Declare Function initColorTemp Lib "ColorT.dll" (ByRef Timming As Long, ByRef Pattern As Long, ByRef pMaxLv As Long, ByRef pMinLv As Long, ByRef Calibration As Long, ByRef MinBri As Long, ByVal ModelFile As String) As Long

...
Public Declare Function ColorTInit Lib "ColorT.dll" (ByRef pudtConfigData As udtConfigData1) As Long
Public Declare Function ColorTDeInit Lib "ColorT.dll" (ByRef pudtConfigData As udtConfigData1) As Long

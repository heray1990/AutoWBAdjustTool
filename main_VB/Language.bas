...
Public Const TXTGainCoolWrong As String = "ColorTemp_COOL is Wrong, Please Check Again."
Public Const TXTGainStandardWrong As String = "ColorTemp_STANDARD is Wrong, Please Check Again."
Public Const TXTGainWarmWrong As String = "ColorTemp_WARM is Wrong, Please Check Again."
Public Const TXTOffsetCoolWrong As String = "OFFSET_Color_COOL is Wrong, Please Check Again."
Public Const TXTOffsetStandardWrong As String = "OFFSET_Color_STANDARD is Wrong, Please Check Again."
Public Const TXTOffsetWarmWrong As String = "OFFSET_Color_WARM is Wrong, Please Check Again."
